# Copilot Instructions for FabrIQ Codebase

## Overview
This project is a full-stack web application for FabrIQ, a modern fashion retailer, with a React frontend and a Node.js/Express/MongoDB backend. The backend exposes REST APIs for user, product, order, review, payment, and notification management. The frontend is organized by feature and uses React Context for authentication and theming.
