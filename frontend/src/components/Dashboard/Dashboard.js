...
function DashboardPrivileged({ initialTab }) {
  ...
  return (
    <div className="admin-dashboard">
      <div className="dashboard-shell dashboard-shell--two-column multi-dashboard admin-dashboard">
        {/* Sidebar */}
          ...
          <nav className="dashboard-nav stack-sm">
            ...
            {isAdmin && (
              <div className="nav-section stack-xs">
                <span className="nav-section__label">Admin suite</span>
                <button
                  type="button"
                                ...
                                <div className="stack-2xs">
                                  ...
                                  <div className="expiry-editor">
                                    ...
                                    {product.expireTrackingEnabled && product.expiryDate ? (
                                      <p
                                        className={`expiry-editor__status ${daysToExpiry !== null && daysToExpiry <= reminderDaysNumber
                                      ...
                                      >
                                        ...
                                        {daysToExpiry !== null
                                          ? ` (${daysToExpiry <= 0 ? "expired" : `${daysToExpiry} day${daysToExpiry === 1 ? "" : "s"
                                            } remaining`})`
                                          : ""}
                                      </p>
                                    ) : (
