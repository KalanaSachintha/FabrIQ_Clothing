    ...
    <footer className="site-footer">
      <div className="footer-top">
        <div className="footer-brand">
          ...
          <p>
            Curate every wardrobe, manage drops, and delight shoppers with FabrIQ’s integrated fashion platform.
          </p>
          <div className="footer-social">
            <a
              ...
              aria-label="Visit FabrIQ on Facebook"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit FabrIQ on Twitter"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit FabrIQ on Instagram"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit FabrIQ on LinkedIn"
            >
        ...
        <div className="footer-contact">
          ...
          <div>
            ...
            <span>123 Fashion Avenue, Style District, Colombo</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span>support@fabriq.lk</span>
          </div>
        </div>
      </div>

      <div className="footer-bottom">
  <p>© {year} FabrIQ. All rights reserved.</p>
        <div className="footer-meta-links">
          <a href="/privacy">Privacy</a>
          <a href="/terms">Terms</a>
          <a href="mailto:support@fabriq.lk">Support</a>
        </div>
      </div>
    </footer>
  );
