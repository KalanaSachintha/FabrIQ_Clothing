                          ...
                          <div>
                            ...
                            {(item.color || item.size) && (
                              <div className="order-item__variants">
                                ...
                                {item.color && item.size ? <span aria-hidden="true">•</span> : null}
              ...
              return (
                <article key={refund._id} className="refunded-item">
                  <div className="refunded-item__info">
                    ...
                    {(refund?.item?.color || refund?.item?.size) && (
                      <div className="refunded-item__variants">
                        {refund?.item?.color && <span>Color: {refund.item.color}</span>}
                        {refund?.item?.color && refund?.item?.size ? (
                          <span aria-hidden="true">•</span>
                        ) : null}
                        {refund?.item?.size && <span>Size: {refund.item.size}</span>}
                      </div>
                    )}
                    {decidedLabel && (
